...
$(function() { 
  ...
  connections.push(r.connection(shapes[1], shapes[5], "#fff"));
  connections.push(r.connection(shapes[2], shapes[5], "#fff"));
  
  connections.push(r.connection(shapes[0], shapes[6], "#fff"));
  connections.push(r.connection(shapes[1], shapes[6], "#fff"));
  connections.push(r.connection(shapes[2], shapes[6], "#fff"));
  
  connections.push(r.connection(shapes[3], shapes[7], "#fff"));
  connections.push(r.connection(shapes[4], shapes[7], "#fff"));
  connections.push(r.connection(shapes[5], shapes[7], "#fff"));
  connections.push(r.connection(shapes[6], shapes[7], "#fff"));
});
